...
(defun player-attack ()
  (fresh-line)
  (princ-before-read "Attack style: [s]tab [d]ouble swing [r]oundhouse:")
  (case (read)
...
(defmethod monster-hit ((m hydra) x)
  (decf (monster-health m) x)
  (if (monster-dead m)
      (princ "The corpse of the fully decaptitated and decapacitated hydra falls to the floor!")
...
#|
  At SBCL 2.1.3, read called after princ (also print) is unexpectedly executed before princ.
  thanks to https://blog.kurokobo.com/archives/141
|#
(defun princ-before-read (string)
  (prin1 string)
  (fresh-line))